package com.example.android.feature.ai.data.service
...
class BackgroundCameraService : LifecycleService() {
    ...
    private fun startForegroundService(text: String) {
        ...
        val notificationIntent = Intent(this, com.example.android.feature.home.HomeActivity::class.java)
    ...
    private fun analyzeGestures() {
        ...
        val action = gestureAnalyzer.analyze(CameraSharedState.lastHandResult, isFrontCamera)

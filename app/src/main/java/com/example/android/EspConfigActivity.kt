...
class EspConfigActivity : AppCompatActivity() {
     ...
     * disponible (o navega directo si no hay aparatos registrados). Si tu flujo de negocio
     * requiere elegir entre varios aparatos, aquí es el punto de extensión: agrega un
     * selector antes de llamar a guardarConfiguracionRed().
     */
